<template>
  <div class="footer">
    <div class="footer-top">
      <div class="container">
        <div class="footer-group">
          <div class="footer-name">Продукция</div>
          <div class="footer-links">
            <a href="#">Интегральные микросхемы</a>
            <a href="#">Транзисторы</a>
            <a href="#">Диоды</a>
            <a href="#">Автомобильная электроника</a>
            <a href="#">Другая продукция</a>
            <a href="#">Силовые блоки</a>
          </div>
        </div>
        <div class="footer-group">
          <div class="footer-name">Предприятие</div>
          <div class="footer-links">
            <a href="#">О предприятии</a>
            <a href="#">История</a>
            <a href="#">Компетенция</a>
            <a href="#">Награды</a>
          </div>
        </div>
        <div class="footer-group">
          <div class="footer-name">Карьера</div>
          <div class="footer-links">
    ...
    <div class="footer-bot">
      <div class="container">
        <div class="footer-copy">2019 © АО «ВЗПП-С»</div>
        <div class="footer-politics"><a href="#">Политика конфиденциальности</a></div>
